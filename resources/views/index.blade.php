...
<body>
    ...
    <div class="section" id="info">
        ...
        <div class="section-content">
            ...
            <h1 class="desktop-only">חולמים על לנד קרוזר<br>חדש? <span class="red">קבלו אותו<br>ישר לסלון שלכם!</span>
            </h1>
            ...
            <div class="instructions">
                ...
                <div class="box">
                    ...
                    <div class="content desktop-only">קחו את הלנד קרוזר לנסיעה בלתי<br>נשכחת וצלמו תמונה
                        יצירתית<br>שמשלבת את המציאות הרבודה<br>עם המציאות האמיתית</div>
                    <div class="content mobile-only">קחו את הלנד קרוזר לנסיעה בלתי נשכחת<br>וצלמו תמונה יצירתית שמשלבת
                        את המציאות<br>הרבודה עם המציאות האמיתית</div>
                </div>
                <div class="arrow desktop-only"><img src="{{ asset('assets/images/arrow-left.png')}}" /></div>
                <div class="arrow mobile-only"><img src="{{ asset('assets/images/mobile-arrow.png')}}" /></div>
                <div class="box">
                    <p class="title"><span class="red">שלב 3 :</span>העלו תמונה</p>
                    <div class="content desktop-only">העלו את התמונה לאתר ואולי<br>תזכו בלנד קרוזר לסופ"ש<br>כולל דלק
                        וטיול שטח מודרך</div>
                    <div class="content mobile-only">העלו את התמונה לאתר ואולי תזכו בלנד קרוזר<br>לסופ"ש כולל דלק וטיול
                        שטח מודרך</div>
                </div>
            </div>
        </div>
    ...
    <div class="section" id="form">
        ...
        <div class="section-content">
            ...
            <form id="upload" class="upload-form" enctype="multipart/form-data" method="post">
                @csrf
                <div class="preview desktop-only"><img class="upload-img"
                        src="{{asset('./assets/images/upload.png')}}" /></div>
                <label for="file-upload" class="custom-file-upload desktop-only">או העלו קובץ</label>
                <label for="file-upload" class="openPopup custom-file-upload mobile-only"><img
                        src="{{ asset('assets/images/mobile-upload.png')}}" />העלו קובץ לגלריה > </label>
                <input type="file" id="file-upload" name="file" accept="image/*">
                <p class="error_message" id="img_error"></p>
            </form>

            <div class="lead-wrapper">
                <p class="form-text desktop-only">עכשיו נשאר רק למלא את<br>הפרטים כדי שנוכל לחזור<br>אליכם במקרה וזכיתם:
                </p>
                <p class="form-text mobile-only">עכשיו נשאר רק למלא את<br>הפרטים כדי שנוכל לחזור אליכם<br>במקרה וזכיתם
                </p>
